...
const testimonials = [
  ...
  },
  {
    ...
    avatar: 'MS',
    rating: 5,
    text: "I created a beautiful ad page in literally 5 minutes. The AI wrote better copy than I ever could. My online orders doubled since using NowQR. The best part is the animated ScanLogo — customers love scanning it right from the counter display.",
    metric: '2x',
    metricLabel: 'Orders',
  },
  {
  ...
  },
  {
    ...
    avatar: 'SK',
    rating: 5,
    text: "The animated QR is a conversation starter. Patients love it. And changing where it links is just one click in the dashboard. We've seen a 40% increase in online bookings since we started using NowQR at our front desk.",
    metric: '+40%',
  ...
  },
  {
    ...
    avatar: 'DO',
    rating: 5,
    text: "We raised $15,000 with a single ScanLogo on our event posters. The give.nowqr.com link looked professional and trustworthy.",
    metric: '$15k',
    metricLabel: 'Raised',
  },
  {
      ...
      <div ref={ref}>
        ...
        <div className={`text-center max-w-3xl mx-auto mb-14 px-4 ${isVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
          ...
          <p className="text-lg text-muted-foreground">
            See how churches, restaurants, salons, and nonprofits are using NowQR to drive real action.
          </p>
        </div>
