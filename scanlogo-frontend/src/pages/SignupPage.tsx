...
export default function SignupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success('Account created! Welcome to ScanLogo!')
      navigate('/dashboard')
    } catch (err: any) {
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-primary/5 border-r border-border relative overflow-hidden">
        ...
        <div className="relative p-12 max-w-md">
          ...
          <p className="text-muted-foreground text-sm leading-relaxed mb-8">
            Join businesses using ScanLogo to create professional ad pages and animated QR buttons.
          </p>
        ...
        <div className="w-full max-w-md">
          <div className="mb-8">
            <Link to="/" className="flex items-center gap-2 mb-8 lg:hidden">
              ...
              <span className="text-xl font-bold">Scan<span className="text-primary">Logo</span></span>
            </Link>
