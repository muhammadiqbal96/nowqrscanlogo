...
const plans = [
  {
    ...
    price: '$0',
    period: 'forever',
    description: 'Try NowQR and explore all the features before you commit.',
...
const faqs = [
  {
    ...
    a: 'Correct! NowQR uses a one-time payment model. You buy credits and use them at your own pace. No recurring charges, no surprise fees.',
  },
  {
  ...
  {
    q: 'Can I use NowQR for my clients?',
