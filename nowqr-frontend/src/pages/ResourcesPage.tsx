...
const resourceCategories = [
  ...
  },
  {
    ...
    articles: [
      'NowQR platform walkthrough (5 min)',
...
const generalFaqs = [
  ...
  {
    q: 'Do I need a website to use NowQR?',
    a: 'No! NowQR hosts your ad page for you on our domain (e.g., buy.nowqr.com/yourbrand). You just need a destination URL where you want to send people — this can be a PayPal link, YouTube video, booking page, or any URL.',
  },
  {
  ...
  },
  {
    ...
    a: "Since NowQR is a one-time payment (not a subscription), there's nothing to cancel. We offer a 30-day satisfaction guarantee — if you're not happy, we'll work it out.",
  },
  {
        ...
        <div ref={headerRef} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center max-w-3xl mx-auto ${headerVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
              Guides, tutorials, FAQs, and support — everything you need to get the most out of NowQR.
            </p>
