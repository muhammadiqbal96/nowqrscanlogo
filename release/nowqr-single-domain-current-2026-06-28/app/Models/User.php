...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public function getAvatarUrlAttribute(): ?string
    {
        ...
        // Full URL (e.g., from Google OAuth) — return as-is
        if (str_starts_with($this->avatar, 'http')) return $this->avatar;
        // New direct public path (uploads/avatars/...)
        if (str_starts_with($this->avatar, 'uploads/')) return '/' . $this->avatar;
        // Legacy storage disk path (avatars/...) — use storage symlink path
