...
const solutions = [
  {
    ...
    example: 'buy.scanlogos.com/jordanshop',
  ...
  },
  {
    ...
    example: 'give.scanlogos.com/gracechurch',
    color: 'from-primary to-primary',
    bgColor: 'bg-primary/10',
    iconColor: 'text-primary',
    borderColor: 'border-primary/20',
  },
  {
    ...
    example: 'pay.scanlogos.com/plumberpro',
    color: 'from-primary to-primary',
    bgColor: 'bg-primary/10',
    iconColor: 'text-primary',
    borderColor: 'border-primary/20',
  },
  {
    ...
    example: 'call.scanlogos.com/salonbliss',
    color: 'from-primary to-primary',
    bgColor: 'bg-primary/10',
    iconColor: 'text-primary',
    borderColor: 'border-primary/20',
  },
  {
    ...
    example: 'book.scanlogos.com/drsmith',
    color: 'from-primary to-primary',
    bgColor: 'bg-primary/10',
    iconColor: 'text-primary',
    borderColor: 'border-primary/20',
  },
  {
    ...
    example: 'see.scanlogos.com/pastortom',
    color: 'from-primary to-primary',
    bgColor: 'bg-primary/10',
    iconColor: 'text-primary',
    borderColor: 'border-primary/20',
        ...
        <div ref={headerRef} className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center max-w-3xl mx-auto ${headerVisible ? 'animate-fade-in-up' : 'opacity-0'}`}>
            ...
            <p className="text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto">
              Whether you want people to buy, give, book, call, or watch, ScanLogo creates the bridge between your ad and their action.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 lg:py-28">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-xl mx-auto">
            ScanLogo supports custom call-to-actions. Enter any destination URL and create a campaign that fits your unique business needs.
          </p>
          <Link
            to="/signup"
